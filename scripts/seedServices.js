...
const SERVICES = [
  ...
  { serviceId: 'ea-play', name: 'EA Play', category: 'gaming', brandColor: '#000000', sortOrder: 3004 },
  { serviceId: 'apple-arcade', name: 'Apple Arcade', category: 'gaming', brandColor: '#7D57C1', sortOrder: 3005 },
  { serviceId: 'google-play-pass', name: 'Google Play Pass', category: 'gaming', brandColor: '#01875F', sortOrder: 3006 },
  { serviceId: 'ubisoft-plus', name: 'Ubisoft+', category: 'gaming', brandColor: '#0474B5', sortOrder: 3007 },
  ...
  { serviceId: 'sams-club', name: "Sam's Club", category: 'shopping', brandColor: '#0073CE', sortOrder: 6009 },
  { serviceId: 'costco', name: 'Costco', category: 'shopping', brandColor: '#005DAA', sortOrder: 6010 },
  { serviceId: 'bjs', name: "BJ's Wholesale", category: 'shopping', brandColor: '#E31837', sortOrder: 6011 },
  { serviceId: 'target-circle', name: 'Target Circle 360', category: 'shopping', brandColor: '#CC0000', sortOrder: 6012 },
...
const SERVICE_TIERS = {
  netflix: [
    { name: 'Standard with ads', priceCents: 899, billingCycle: 'monthly' },
    { name: 'Standard', priceCents: 1999, billingCycle: 'monthly' },
    { name: 'Premium', priceCents: 2699, billingCycle: 'monthly' },
  ],
  'amazon-prime-video': [{ name: 'Prime Video (standalone)', priceCents: 899, billingCycle: 'monthly' }],
  disney: [
    { name: 'Basic (with ads)', priceCents: 1199, billingCycle: 'monthly' },
    { name: 'Premium (no ads)', priceCents: 1899, billingCycle: 'monthly' },
  ],
  hbo: [
    { name: 'Basic with ads', priceCents: 1099, billingCycle: 'monthly' },
    { name: 'Standard', priceCents: 1849, billingCycle: 'monthly' },
    { name: 'Premium', priceCents: 2299, billingCycle: 'monthly' },
  ],
  'youtube-premium': [
    { name: 'Individual', priceCents: 1599, billingCycle: 'monthly' },
    { name: 'Family (up to 6 members)', priceCents: 2699, billingCycle: 'monthly' },
    { name: 'Student', priceCents: 899, billingCycle: 'monthly' },
  ],
  hulu: [
    { name: 'Hulu (With Ads)', priceCents: 1199, billingCycle: 'monthly' },
    { name: 'Hulu (No Ads)', priceCents: 1899, billingCycle: 'monthly' },
    {
    ...
    { name: 'Live TV Only', priceCents: 8899, billingCycle: 'monthly' },
    { name: 'Hulu + Live TV Español, Disney+', priceCents: 2999, billingCycle: 'monthly' },
    { name: 'Live TV Only Español', priceCents: 2899, billingCycle: 'monthly' },
  ],
  paramount: [
    { name: 'Essential (with ads)', priceCents: 900, billingCycle: 'monthly' },
    { name: 'Premium (no ads)', priceCents: 1400, billingCycle: 'monthly' },
  ],
  appletv: [{ name: 'Apple TV', priceCents: 1299, billingCycle: 'monthly' }],
  peacock: [
    { name: 'Select', priceCents: 799, billingCycle: 'monthly' },
    { name: 'Standard', priceCents: 1099, billingCycle: 'monthly' },
    { name: 'Premium Plus', priceCents: 1699, billingCycle: 'monthly' },
  ],
  crunchyroll: [
    { name: 'Fan', priceCents: 1000, billingCycle: 'monthly' },
    { name: 'Mega Fan', priceCents: 1400, billingCycle: 'monthly' },
    { name: 'Ultimate Fan', priceCents: 1800, billingCycle: 'monthly' },
  ],
  spotify: [
    { name: 'Individual', priceCents: 1299, billingCycle: 'monthly' },
    { name: 'Duo', priceCents: 1899, billingCycle: 'monthly' },
    { name: 'Family', priceCents: 2199, billingCycle: 'monthly' },
    { name: 'Student', priceCents: 699, billingCycle: 'monthly' },
  ],
  'apple-music': [
  ...
  'youtube-music': [
    ...
    { name: 'Family', priceCents: 1899, billingCycle: 'monthly' },
    { name: 'Student', priceCents: 599, billingCycle: 'monthly' },
  ],
  audible: [
  ...
  'xbox-gp': [
    ...
    { name: 'Premium', priceCents: 1499, billingCycle: 'monthly' },
    { name: 'Ultimate', priceCents: 2999, billingCycle: 'monthly' },
  ],
  'ps-plus': [
    { name: 'Essential', priceCents: 999, billingCycle: 'monthly' },
  ...
  nintendo: [
    ...
    { name: 'Individual + Expansion Pack', priceCents: 4999, billingCycle: 'yearly' },
    { name: 'Family + Expansion Pack', priceCents: 7999, billingCycle: 'yearly' },
  ],
  'ea-play': [
    { name: 'EA Play', priceCents: 600, billingCycle: 'monthly' },
    { name: 'EA Play (Annual)', priceCents: 4000, billingCycle: 'yearly' },
    { name: 'EA Play Pro', priceCents: 1700, billingCycle: 'monthly' },
    { name: 'EA Play Pro (Annual)', priceCents: 12000, billingCycle: 'yearly' },
  ],
  'apple-arcade': [
    { name: 'Monthly', priceCents: 500, billingCycle: 'monthly' },
    { name: 'Annual', priceCents: 5000, billingCycle: 'yearly' },
  ],
  'google-play-pass': [
    { name: 'Monthly', priceCents: 500, billingCycle: 'monthly' },
    { name: 'Annual', priceCents: 3000, billingCycle: 'yearly' },
  ],
  'ubisoft-plus': [
    { name: 'Classics', priceCents: 799, billingCycle: 'monthly' },
    { name: 'Premium', priceCents: 1799, billingCycle: 'monthly' },
  ],
  chatgpt: [
  ...
  onedrive: [
    { name: '100GB', priceCents: 199, billingCycle: 'monthly' },
    { name: 'Microsoft 365 Personal', priceCents: 999, billingCycle: 'monthly' },
    { name: 'Microsoft 365 Family', priceCents: 1299, billingCycle: 'monthly' },
  ],
  'amazon-prime': [
  ...
  shipt: [
    { name: 'Monthly', priceCents: 1099, billingCycle: 'monthly' },
  ...
  'sams-club': [
    { name: 'Club', priceCents: 6000, billingCycle: 'yearly' },
    { name: 'Club Plus', priceCents: 12000, billingCycle: 'yearly' },
  ],
  costco: [
    { name: 'Gold Star', priceCents: 6500, billingCycle: 'yearly' },
    { name: 'Executive', priceCents: 13500, billingCycle: 'yearly' },
  ],
  bjs: [
    { name: 'Club', priceCents: 6000, billingCycle: 'yearly' },
    { name: 'Club+', priceCents: 12000, billingCycle: 'yearly' },
  ],
  'target-circle': [
    { name: 'Monthly', priceCents: 1099, billingCycle: 'monthly' },
    { name: 'Annual', priceCents: 9900, billingCycle: 'yearly' },
  ...
  adobe: [
    { name: 'Creative Cloud Standard', priceCents: 5499, billingCycle: 'monthly' },
    { name: 'Creative Cloud Pro', priceCents: 6999, billingCycle: 'monthly' },
  ],
  m365: [
    { name: 'Personal', priceCents: 999, billingCycle: 'monthly' },
    { name: 'Family', priceCents: 1299, billingCycle: 'monthly' },
  ],
  duolingo: [
    { name: 'Super', priceCents: 1299, billingCycle: 'monthly' },
    { name: 'Max', priceCents: 2999, billingCycle: 'monthly' },
  ],
  nyt: [
    { name: 'Basic', priceCents: 2000, billingCycle: 'monthly' },
    { name: 'All Access', priceCents: 2500, billingCycle: 'monthly' },
  ],
  athletic: [
    { name: 'Monthly', priceCents: 899, billingCycle: 'monthly' },
    { name: 'Annual', priceCents: 7188, billingCycle: 'yearly' },
  ],
  masterclass: [
  ...
  peloton: [
    { name: 'App One', priceCents: 1299, billingCycle: 'monthly' },
    { name: 'App+', priceCents: 2899, billingCycle: 'monthly' },
    { name: 'All-Access (equipment)', priceCents: 4999, billingCycle: 'monthly' },
  ],
  strava: [{ name: 'Individual', priceCents: 1199, billingCycle: 'monthly' }],
  mfp: [
    { name: 'Premium', priceCents: 1999, billingCycle: 'monthly' },
    { name: 'Premium+', priceCents: 2499, billingCycle: 'monthly' },
  ],
  headspace: [
  ...
  ipsy: [
    { name: 'Glam Bag', priceCents: 1500, billingCycle: 'monthly' },

...
const SVC: Svc[] = [
  ...
  { id: 'chatgpt', name: 'ChatGPT Plus', category: 'ai', brandColor: '#10A37F', iconType: 'grid', sortOrder: 4001 },
  { id: 'claude', name: 'Claude Pro', category: 'ai', brandColor: '#CC785C', iconType: 'grid', sortOrder: 4002 },
  { id: 'copilot', name: 'Copilot Pro', category: 'ai', brandColor: '#0078D4', iconType: 'grid', sortOrder: 4003 },
  { id: 'gemini', name: 'Gemini Advanced', category: 'ai', brandColor: '#4285F4', iconType: 'grid', sortOrder: 4004 },
  { id: 'midjourney', name: 'Midjourney', category: 'ai', brandColor: '#000000', iconType: 'brush', sortOrder: 4005 },
  ...
  { id: 'dropbox', name: 'Dropbox', category: 'cloud', brandColor: '#0061FF', iconType: 'box-open', sortOrder: 5003 },
  { id: 'onedrive', name: 'OneDrive', category: 'cloud', brandColor: '#0078D4', iconType: 'cloud', sortOrder: 5004 },
  { id: 'amazon-prime', name: 'Amazon Prime', category: 'shopping', brandColor: '#FF9900', iconType: 'box-open', sortOrder: 6001 },
  { id: 'walmart-plus', name: 'Walmart+', category: 'shopping', brandColor: '#0071CE', iconType: 'box-open', sortOrder: 6002 },
  { id: 'instacart', name: 'Instacart+', category: 'shopping', brandColor: '#43B02A', iconType: 'box-open', sortOrder: 6003 },
  { id: 'doordash', name: 'DoorDash DashPass', category: 'shopping', brandColor: '#FF3008', iconType: 'box-open', sortOrder: 6004 },
  { id: 'uber-one', name: 'Uber One', category: 'shopping', brandColor: '#000000', iconType: 'box-open', sortOrder: 6005 },
  { id: 'shipt', name: 'Shipt', category: 'shopping', brandColor: '#C8102E', iconType: 'box-open', sortOrder: 6006 },
  { id: 'thrive', name: 'Thrive Market', category: 'shopping', brandColor: '#2A5934', iconType: 'box-open', sortOrder: 6007 },
  { id: 'chewy', name: 'Chewy Autoship', category: 'shopping', brandColor: '#0051A5', iconType: 'box-open', sortOrder: 6008 },
  { id: 'adobe', name: 'Adobe CC', category: 'apps', brandColor: '#FF0000', iconType: 'brush', sortOrder: 7001 },
  { id: 'm365', name: 'Microsoft 365', category: 'apps', brandColor: '#D83B01', iconType: 'grid', sortOrder: 7002 },
  { id: 'duolingo', name: 'Duolingo Plus', category: 'apps', brandColor: '#58CC02', iconType: 'grid', sortOrder: 7003 },
  { id: 'nyt', name: 'New York Times', category: 'apps', brandColor: '#000000', iconType: 'grid', sortOrder: 7004 },
  { id: 'athletic', name: 'The Athletic', category: 'apps', brandColor: '#000000', iconType: 'grid', sortOrder: 7005 },
  { id: 'masterclass', name: 'MasterClass', category: 'apps', brandColor: '#000000', iconType: 'grid', sortOrder: 7006 },
  { id: 'peloton', name: 'Peloton', category: 'fitness', brandColor: '#E01F2D', iconType: 'play-triangle', sortOrder: 8001 },
  { id: 'strava', name: 'Strava', category: 'fitness', brandColor: '#FC4C02', iconType: 'play-triangle', sortOrder: 8002 },
  { id: 'mfp', name: 'MyFitnessPal', category: 'fitness', brandColor: '#0073E6', iconType: 'grid', sortOrder: 8003 },
  { id: 'headspace', name: 'Headspace', category: 'fitness', brandColor: '#FF6200', iconType: 'play-triangle', sortOrder: 8004 },
  { id: 'ipsy', name: 'IPSY', category: 'lifestyle', brandColor: '#E91E8C', iconType: 'box-open', sortOrder: 9001 },
  { id: 'stitch-fix', name: 'Stitch Fix', category: 'lifestyle', brandColor: '#2A4A7F', iconType: 'box-open', sortOrder: 9002 },
  { id: 'fabfitfun', name: 'FabFitFun', category: 'lifestyle', brandColor: '#F2657A', iconType: 'box-open', sortOrder: 9003 },
  { id: 'hellofresh', name: 'HelloFresh', category: 'lifestyle', brandColor: '#8DB600', iconType: 'box-open', sortOrder: 9004 },
  { id: 'blue-apron', name: 'Blue Apron', category: 'lifestyle', brandColor: '#4B6CB7', iconType: 'box-open', sortOrder: 9005 },
  { id: 'kiwico', name: 'KiwiCo', category: 'lifestyle', brandColor: '#E8792A', iconType: 'box-open', sortOrder: 9006 },
  { id: 'barkbox', name: 'BarkBox', category: 'lifestyle', brandColor: '#4DBCE9', iconType: 'box-open', sortOrder: 9007 },
];

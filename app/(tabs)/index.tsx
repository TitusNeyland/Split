...
const styles = StyleSheet.create({
  ...
  fcMid: { flex: 1 },
  fcTitle: { fontSize: 14, fontWeight: '500', color: C.text },
  fcSub: { fontSize: 11, color: C.muted, marginTop: 2 },
  fcRight: { alignItems: 'flex-end' },
  fcAmt: { fontSize: 15, fontWeight: '500' },
  fcDetail: { fontSize: 11, color: C.muted, marginTop: 2 },
  body: {
  ...
  bpEmoji: { fontSize: 12 },
  bpName: { flex: 1, fontSize: 12, fontWeight: '500', color: C.text },
  bpNameEmpty: { flex: 1, fontSize: 12, fontWeight: '500', color: C.muted },
  bpWhen: { fontSize: 11, color: C.red, fontWeight: '500' },
  bpAmt: { fontSize: 12, fontWeight: '600', color: C.red, marginLeft: 4 },
  listCard: {
    backgroundColor: '#fff',
    borderRadius: 18,
    borderWidth: 0.5,
  ...
  friendAvTxt: { fontSize: 11, fontWeight: '600' },
  friendMid: { flex: 1 },
  fnName: { fontSize: 13, fontWeight: '500', color: C.text },
  fnSub: { fontSize: 11, color: C.muted, marginTop: 1 },
  friendBal: { alignItems: 'flex-end' },
  fbAmt: { fontSize: 14, fontWeight: '600' },
  fbAction: { fontSize: 10, color: C.muted, marginTop: 2 },
  emptyFriends: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#fff',
  ...
  emptyFriendsTitle: { fontSize: 13, fontWeight: '600', color: C.text },
  emptyFriendsSub: { fontSize: 11, color: C.muted, marginTop: 2 },
  subRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
  ...
  subMid: { flex: 1 },
  subName: { fontSize: 13, fontWeight: '500', color: C.text },
  subMeta: { fontSize: 11, color: C.muted, marginTop: 1 },
  subRight: { alignItems: 'flex-end' },
  subAmt: { fontSize: 13, fontWeight: '500', color: C.text },
  subStatus: { fontSize: 10, fontWeight: '500', marginTop: 1 },
  emptySplitCard: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#fff',
  ...
  emptySplitTitle: { fontSize: 14, fontWeight: '600', color: C.text },
  emptySplitSub: { fontSize: 11, color: C.muted, marginTop: 3 },
  actRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
  ...
  actTxt: { flex: 1, fontSize: 12, color: C.muted },
  actAmt: { fontSize: 12, fontWeight: '500' },
  emptyActivity: {
    backgroundColor: '#fff',
    borderRadius: 18,
    borderWidth: 0.5,
  ...
  emptyActivityTxt: { fontSize: 12, color: C.muted, lineHeight: 18 },
  setupWrap: {
    backgroundColor: '#fff',
    borderRadius: 14,
    paddingVertical: 12,
  ...
  setupLbl: { fontSize: 12, fontWeight: '500', color: C.text },
  setupAction: { fontSize: 12, fontWeight: '500', color: C.purple },
  setupTrack: {
    height: 5,
    borderRadius: 3,

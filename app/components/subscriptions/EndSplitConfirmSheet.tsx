...
export type EndSplitConfirmSheetProps = {
  visible: boolean;
  onClose: () => void;
  ...
  pendingWarning: { memberName: string; amountFormatted: string } | null;
  confirming: boolean;
};
...
export function EndSplitConfirmSheet({
  visible,
  onClose,
  onConfirm,
  subscriptionName,
        ...
        >
          ...
          >
            ...
            <View style={styles.infoCard}>
              ...
              <View style={styles.infoRow}>
                <Text style={styles.infoLbl}>Billing stops</Text>
                <Text style={[styles.infoVal, styles.infoValRed]}>Immediately</Text>
              </View>
              <View style={styles.infoRow}>
                <Text style={styles.infoLbl}>History saved</Text>
                <Text style={[styles.infoVal, styles.infoValGreen]}>Forever ✓</Text>
              </View>
              <View style={styles.infoRow}>
                <Text style={styles.infoLbl}>Settings saved</Text>
                <Text style={[styles.infoVal, styles.infoValGreen]} numberOfLines={2}>
                  {settingsSavedLine}
                </Text>
              </View>
            ...
            {pendingWarning ? (
              <View style={styles.warnBanner}>
                ...
                <Text style={styles.warnTxt}>
                  {pendingWarning.memberName} still owes {pendingWarning.amountFormatted}. Remind them before
                  ending.
                </Text>
              </View>
            ) : null}
            ...
            <Pressable
              ...
              accessibilityLabel="End split"
            >
              {confirming ? (
                <ActivityIndicator color="#fff" />
              ) : (
                <Text style={styles.btnEndTxt}>End split</Text>
              )}
            </Pressable>
            <Pressable
              onPress={dismiss}

...
const styles = StyleSheet.create({
  ...
  emptyBtnTxt: { color: '#fff', fontWeight: '600', fontSize: 17 },
  ...
  aiTxt: { fontSize: 13, color: 'rgba(255,255,255,0.88)', flex: 1 },
  floatCard: {
    backgroundColor: '#fff',
    borderRadius: 22,
    marginHorizontal: 14,
  ...
  afTitle: { fontSize: 16, fontWeight: '600', color: C.text },
  ...
  liName: { fontSize: 16, fontWeight: '500', color: C.text, flex: 1 },
  liNameMuted: { color: C.muted },
  liStrike: { opacity: 0.45 },
  warnIcon: { marginTop: 1 },
  unreadHint: { fontSize: 13, color: C.warn, marginTop: 2 },
  liQty: { fontSize: 14, color: C.muted, marginRight: 2 },
  assignPill: { borderRadius: 10, paddingVertical: 4, paddingHorizontal: 9, maxWidth: 90 },
  assignPillTxt: { fontSize: 12, fontWeight: '600' },
  liPrice: { fontSize: 16, fontWeight: '600', color: C.text, minWidth: 52, textAlign: 'right' },
  ...
  tipLbl: { fontSize: 16, fontWeight: '500', color: C.text },
  ...
  totalsTitle: { fontSize: 14, fontWeight: '600', color: C.muted, textTransform: 'uppercase', letterSpacing: 0.6 },
  totalsMeta: { fontSize: 13, color: C.muted },
  ...
  ptPipTxt: { fontSize: 12, fontWeight: '700' },
  ptName: { flex: 1, fontSize: 16, color: C.text },
  ptBarWrap: { width: 70, height: 4, backgroundColor: '#F0EEE9', borderRadius: 2, overflow: 'hidden' },
  ptBar: { height: '100%', borderRadius: 2 },
  ptAmt: { fontSize: 16, fontWeight: '600', color: C.text, minWidth: 56, textAlign: 'right' },
  grandRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  grandLbl: { fontSize: 16, fontWeight: '500', color: C.text },
  grandAmt: { fontSize: 22, fontWeight: '700', color: C.text, letterSpacing: -0.4 },
  confirmBtn: {
  ...
  confirmBtnTxt: { color: '#fff', fontSize: 18, fontWeight: '600' },
  ...
  modalLbl: { fontSize: 14, fontWeight: '600', color: C.muted, marginBottom: 6, marginTop: 10 },
  input: {
    borderWidth: 0.5,
    borderColor: C.border,
    borderRadius: 10,
  ...
  modalCancelTxt: { fontSize: 18, color: C.muted, fontWeight: '500' },
  modalSave: { backgroundColor: C.purple, paddingVertical: 12, paddingHorizontal: 24, borderRadius: 12 },
  modalSaveTxt: { color: '#fff', fontWeight: '600', fontSize: 18 },
});

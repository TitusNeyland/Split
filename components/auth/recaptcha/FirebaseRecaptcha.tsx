...
function getWebviewSource(
  ...
  const v = firebaseVersion || '8.10.0';
  return {
...
function validateFirebaseConfig(firebaseConfig: FirebaseOptions | undefined): asserts firebaseConfig is FirebaseOptions {
  if (!firebaseConfig) {
    throw new RecaptchaVerifierError(
      'ERR_FIREBASE_RECAPTCHA_CONFIG',
      'Missing firebase web configuration. Pass the "firebaseConfig" prop.'
    );
  }
